...
class Rope{
    ...
    constructor(ctx,quantity,options,image){
        ...
        for(let x = 1; x < quantity; x++){
            ...
            this.points.push(new Point(pos_x,pos_y,0,Math.random()*20,{color:options.color,gravity:options.gravity,x_size:options.obj_width,y_size:options.obj_height,air_friction:options.air_friction,bounce_type:options.bounce_type}));
        }
