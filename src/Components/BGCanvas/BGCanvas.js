...
import Canvas_manager from './CanvasManager/cnavas_manager'
import default_options from './Options.js'
import { to_blob } from './FileReader';
 ...
 */
export default function BGCanvas({src,width,height,options = default_options, className=''}) {
  ...
  return (
    <canvas className={className} ref={canvas_ref} onMouseMove={handleMouseMove} width={dimensions.width} height={dimensions.height}>BGCanvas</canvas>
  )
}
