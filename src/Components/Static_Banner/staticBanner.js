    ...
    <div className='Static-Banner'>
        <div className='Static-Banner-Left'>
          <div className='Static-Banner-Left-Data'>
            ...
            <h1>8th edition of the Genetics Conference "Genomica"</h1>
            <p><span className='delete_res'>The whole team is actively working on preparing the event, and we can now confirm its dates. Join us from May 17-19, 2024, at the Institute of Zoology, Jagiellonian University in Krakow.
